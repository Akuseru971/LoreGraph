...
export const shurimaTargonSeeds: CharacterSeed[] = [
  {
    ...
    long: [
      ...
      "Something in the Ascended broke during those centuries. Immortality without an end condition curdled into appetite, and the heroes who had saved Shurima became the reason it needed saving again.",
      "The mortals who had built them fought back, and Targon intervened. Aatrox could not be killed, so he was sealed inside his own weapon instead.",
      "When a mortal picks up Aatrox's blade, he takes the body and remakes it into a shape he recognises, wearing the wielder until there is nothing left to wear.",
    ...
    timeline: [
      ...
      },
      {
        ...
        description:
          "Imprisoned — bound into the sword he fought with after the Aspect of War intervened in the Darkin War.",
        event: "darkin-war",
        sourceIds: ["source:bio-aatrox"],
      ...
      },
      {
        ...
        claimIds: ["claim:aatrox-fought-pantheon"],
        reviewStatus: "VERIFIED_CANON",
        canonStatus: "CURRENT_CANON",
        evidenceClass: "FACT",
      },
  ...
  },
  {
    ...
    timeline: [
      ...
      },
      {
        ...
        description:
          "Atreus becomes the mortal vessel for the Aspect of War — a celestial entity distinct from the ancient campaign that sealed the Darkin.",
        sourceIds: ["source:bio-pantheon"],
        claimIds: ["claim:pantheon-hosted-aspect-of-war"],
        reviewStatus: "VERIFIED_CANON",
        canonStatus: "CURRENT_CANON",
